...
const MOCK_NOTIFS = [
  {
    id: 1,
    title: 'Claim Automatically Triggered',
    desc: 'Heavy rainfall detected in your zone (Chennai Central). Processing ₹450 payout.',
    time: '5m ago',
    type: 'claim',
    isNew: true,
  },
  {
    id: 2,
    title: 'Rain Hazard Alert',
    desc: 'Moderate rainfall expected between 5 PM - 8 PM. Safe modes activated.',
    time: '2h ago',
    type: 'risk',
    isNew: false,
  },
  {
    ...
    desc: 'You earned ₹4,250 this week. Great job! Check your detailed breakdown.',
    time: '1d ago',
    type: 'earnings',
    isNew: false,
  },
  {
    id: 4,
    title: 'Shield Bonus Available',
    desc: 'Maintain your safety score above 90% for 3 more days to get ₹200 bonus.',
    time: '2d ago',
    type: 'shield',
    isNew: false,
  },
